 ...
 *
 * the error shown is The inferior stopped because it received a signal from the operating system.
 *
 * the cycle causing stackoverflow is
 * 137,549,327,203,685,164
 */
