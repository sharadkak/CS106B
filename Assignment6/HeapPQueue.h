...
private:
    ...
    // for bubble up algorithm, passing array pointer as reference
    void _BubbleUp(int index);

    // for bubble down algorithm
    void _BubbleDown(int index);

    // increase the array
    void _StretchArray();

    // swap funciton that accepts indices of the elems array to swap values
